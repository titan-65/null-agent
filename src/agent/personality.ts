...
export function getPersonalityPrompt(config: PersonalityConfig): string {
  ...
  parts.push("");
  parts.push("Conversational guidelines:");
  parts.push("- Acknowledge what they said before responding");
  parts.push("- Ask natural follow-up questions");
  parts.push("- Reference earlier parts of the conversation");
  parts.push("- Don't repeat yourself");
  parts.push("- If they're brief, be brief back");
  parts.push("- If they're detailed, match their level of detail");
